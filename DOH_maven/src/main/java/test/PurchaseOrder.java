...
public class PurchaseOrder {
    ...
    protected PurchaseOrder.Header header;
    @XmlElement(name = "Items", required = true, nillable = true)
    protected List<PurchaseOrder.Items> items;
     ...
     * @return
     *     possible object is
     *     {@link PurchaseOrder.Header }
     *     
     */
    public PurchaseOrder.Header getHeader() {
        return header;
    }
     ...
     *     
     */
    public void setHeader(PurchaseOrder.Header value) {
        this.header = value;
    }
     ...
     * 
     */
    public List<PurchaseOrder.Items> getItems() {
        if (items == null) {
            items = new ArrayList<PurchaseOrder.Items>();
        }
        return this.items;
    }
